(function (global, factory) {
    ...
    (factory((global.VirgilCryptoUtils = {})));
    ...
    ***************************************************************************** */
    ...
    function createNativeWrapper(utils) {
        ...
        {
            wrapNativeFunction = function wrapNativeFunctionBrowser(fn, target) {
                return function () {
                    var args = [];
                    ...
                    var allocations = [];
                    var transformedArgs = args.map(function (arg) {
                        if (utils.isBuffer(arg)) {
                            var arr = utils.bufferToVirgilByteArray(arg);
                    ...
                    try {
                        ...
                        allocations.forEach(function (arr) { return arr.delete(); });
                    }
                };
            };
        }
