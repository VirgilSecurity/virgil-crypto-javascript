...
describe('encrypt/decrypt', () => {
	...
	it('using keys "RSA_2048" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.RSA_2048);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "RSA_2048" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.RSA_2048, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_BP256R1" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_BP256R1);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_BP256R1" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_BP256R1, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_BP384R1" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_BP384R1);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_BP384R1" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_BP384R1, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_BP512R1" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_BP512R1);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_BP512R1" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_BP512R1, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_SECP256K1" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_SECP256K1);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_SECP256K1" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_SECP256K1, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_SECP256R1" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_SECP256R1);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_SECP256R1" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_SECP256R1, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_SECP384R1" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_SECP384R1);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_SECP384R1" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_SECP384R1, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_SECP521R1" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_SECP521R1);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "EC_SECP521R1" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.EC_SECP521R1, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "FAST_EC_CURVE25519" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.FAST_EC_X25519);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "FAST_EC_CURVE25519" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.FAST_EC_X25519, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "FAST_EC_ED25519" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.FAST_EC_ED25519);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "FAST_EC_ED25519" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeyPairType.FAST_EC_ED25519, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});
