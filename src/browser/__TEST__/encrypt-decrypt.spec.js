...
describe('encrypt/decrypt', () => {
	...
	it('using keys "FAST_EC_CURVE25519" without password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeysTypesEnum.FAST_EC_X25519);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});

	it('using keys "FAST_EC_CURVE25519" with password', () => {
		let decryptedData = encryptDecryptUsingKeyPair(INITIAL_DATA, VirgilCrypto.KeysTypesEnum.FAST_EC_X25519, PASSWORD);
		expect(decryptedData.equals(INITIAL_DATA)).toBe(true);
	});
